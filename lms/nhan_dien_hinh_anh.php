 ...
 <header id="header" class="header fixed-top d-flex align-items-center">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
            ...
            <li class="notification-item">
              ...
              <div>
                <h4>Welcome grade 10 students to test this products!</h4>
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6>Student</h6>
              <span>Tinh Bien High School</span>
            </li>
            <li>
              <hr class="dropdown-divider">
            </li>
  ...
  <main id="main" class="main">
    <div class="card">
      ...
      <div><h5>Nhận diện và tìm kiếm hướng dẫn ngôn ngữ kí hiệu</h5></div>
<button type="button" onclick="init()" class="btn btn-primary">Start</button><br><br><br>
...
<script type="text/javascript">
    ...
    const URL = "https://teachablemachine.withgoogle.com/models/fCc_ITExd/";
    ...
    async function predict() {
        ...
        labelContainer.innerText= 'Result: ' +'\n'+ predictions[0].className; 
    }
</script>
  ...
  <footer id="footer" class="footer">
    ...
    <div class="credits">
      ...
      Designed by <a href="#">Tuấn Kiệt </a>
    </div>
  </footer><!-- End Footer -->
