...
<?php
 ...
 $link=mysqli_connect("localhost","id22065658_handtalkeradmin","Tuankiet@2518"); 
 mysqli_select_db($link,"id22065658_handtalkerdb"); 
 $test=array(); 
 
 $count=0; 
 $res=mysqli_query($link,"SELECT * FROM lessons"); 
 while($row=mysqli_fetch_array($res)){
     $test[$count]["label"]=$row["lesson_id"]; 
     $test[$count]["y"]=$row["completed"]; 
     $count=$count+1;
 }
 ?>
 <!DOCTYPE HTML>
 ...
 <body>
 <h3>📊 Biểu đồ thống kê số lượt hoàn thành bài học</h3>
 <div id="chartContainer" style="height: 370px; width: 50%;"></div>
 <script src="https://cdn.canvasjs.com/canvasjs.min.js"></script>
 <h3>📊 Biểu đồ thống kê số giờ học</h3>
 </body>
 </html>  
